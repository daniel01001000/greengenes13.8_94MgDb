### =========================================================================
### Downloading database greengenes 13_8 94 OTU database
...
getGreenGenes13.8.94Db <- function(
        db_name = "gg_13_8_OTU94",
        seq_url = "ftp://greengenes.microbio.me/greengenes_release/gg_13_8_otus/rep_set/94_otus.fasta",
        taxa_url = "ftp://greengenes.microbio.me/greengenes_release/gg_13_8_otus/taxonomy/94_otu_taxonomy.txt",
        tree_url = "ftp://greengenes.microbio.me/greengenes_release/gg_13_8_otus/trees/94_otus.tree"
){
